package openwebinars.argumentosytiposderetorno.diseniodeclases;
...
public class Rectangulo {
    ...
    // este es un atajo para armar 4 Arrays
    ...
    /*Calculo de base es la diferencia enttre 2 coordenadas
    se usa el Math.abs para numero absoluto*/
    public double base() {
